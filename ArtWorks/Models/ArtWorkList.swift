...
struct ArtWorkData: Codable {
    ...
    let artistDisplay, placeOfOrigin, dimensions, mediumDisplay: String?
    ...
    let galleryTitle, galleryID, artworkTypeTitle, artworkTypeID: JSONNull?
    ...
    let artworkCatalogueIDS: [JSONNull?]?
    ...
    let textIDS: [String]?
    let sectionIDS, sectionTitles: [JSONAny]?
    let siteIDS: [Int]?
